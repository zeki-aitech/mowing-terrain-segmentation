# DeepLabV3 with ResNet-50 backbone on YCOR dataset - Adaptive Strategy (RECOMMENDED)
# Strategy: 70% Log Inverse + 30% Square Root for optimal balance
...
# Adaptive Weighting: 70% Log Inverse + 30% Square Root
adaptive_weights = [
...
# Model configuration with adaptive strategy
model = dict(
