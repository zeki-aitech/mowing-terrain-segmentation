...
inverse_frequency_weights_train = [1.604864,0.951073,0.754461]
sqrt_inverse_weights_train = [2.194218,1.689147,1.504454]
log_inverse_weights_train = [1.571651,1.048448,0.816860]
...
model = dict(
    ...
    decode_head=dict(
        ...
        loss_decode=dict(
            ...
            use_sigmoid=False, 
            loss_weight=1.0,
            # class_weight=sqrt_inverse_weights_train,
            avg_non_ignore=True,
        )
    ),  
    auxiliary_head=dict(
